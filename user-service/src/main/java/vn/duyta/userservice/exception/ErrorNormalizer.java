package vn.duyta.userservice.exception;
...
import vn.duyta.userservice.dto.identity.KeyCloakError;
...
public class ErrorNormalizer {
    ...
    public ErrorNormalizer() {
        ...
        errorCodeMap.put("Username or Password not valid", ErrorCode.NOT_VALID);
    }
